...
import com.forlayo.mediaprojection2yuv.gl.GlDrawer;
import com.forlayo.mediaprojection2yuv.gl.GlGenericDrawer;
import com.forlayo.mediaprojection2yuv.gl.GlShader;
import com.forlayo.mediaprojection2yuv.gl.GlTextureFrameBuffer;
...
public class YuvConverter {
    ...
    public com.forlayo.mediaprojection2yuv.VideoFrame convert(int oesTextureId, float[] transformMatrix, int frameWidth, int frameHeight) {
        ...
        Matrix finalMatrix = new Matrix(convertMatrixToAndroidGraphicsMatrix(transformMatrix));
        ...
        drawTexture(drawer, oesTextureId, finalMatrix, frameWidth, frameHeight,
        ...
        return com.forlayo.mediaprojection2yuv.VideoFrame.wrap(
                frameWidth, frameHeight,
                dataY, dataU, dataV,
                stride, stride, stride);
    }

    public static void drawTexture(GlDrawer drawer, int textureId,
                                   Matrix finalMatrix, int frameWidth, int frameHeight, int viewportX, int viewportY,
                                   int viewportWidth, int viewportHeight) {
